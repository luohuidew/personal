    ...
    <div class="option-cont">
      <div class="option-list bgcolor">
        <div class="main-title clearfix">
          <span class="title">
            <el-input placeholder="搜索姓名/邮箱/员工ID" icon="search"></el-input>
          </span>
